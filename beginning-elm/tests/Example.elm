module Example exposing (additionTests, comparisonTests, guirdianNames)
...
guirdianNames =
    test "only 2 guirdians have names with less than 6 characters" <|
        \_ ->
            let
                guirdians =
...
comparisonTests =
    describe "comparison"
        ...
        , test "a list with some elements is not empty" <|
            \_ ->
                List.isEmpty [ "Jyn", "Cassian", "K-2S0" ]
